...
var DateTimePicker = function (_Events) {
  ...
  createClass(DateTimePicker, [{
    ...
    value: function delegateEvents() {
      ...
      this.$('.js-date-am-pm-mode').addEventListener('click', function (e) {
        return _this5.showHourClock(e);
      }, false);
    ...
    value: function showHourClock() {
      ...
      this.$('.js-date-am-pm-mode').classList.add('active');
    ...
    value: function showMinuteClock() {
      ...
      this.$('.js-date-am-pm-mode').classList.remove('active');
    ...
    value: function setTime(time) {
      var m = moment(time).clone();
      // round minutes to the nearest 5 minute mark
      m.minutes(Math.round(m.minutes() / 5) * 5);
